...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『泽少』"; Text ="核对用户ID中♧"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『泽少』"; Text ="用户ID核对完毕♣"; Duration = 4; })
...
about:Label("感谢所有支持泽少的人")
about:Label("已修复完bug")
about:Label("♦")
about:Label(" 你爸爸回归 ")
about:Label("感谢大家支持泽少")
about:Label("十分感谢")
